...
.trace { display:grid; grid-template-columns:repeat(5,1fr); gap:.35rem; margin-top:.55rem; }
.trace-step { border-top:2px solid #334155; padding-top:.35rem; font-size:.68rem; }
.trace-step b { display:block; font-size:.69rem; letter-spacing:.05em; }
.trace-step span { opacity:.62; }
.mission-objective { border-left:3px solid #64748b; padding:.45rem .7rem; margin:.35rem 0 .65rem; }
.outcome { border:1px solid #334155; border-radius:6px; padding:.65rem .8rem; margin-top:.5rem; }
